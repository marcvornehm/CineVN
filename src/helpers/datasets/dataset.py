...
class Dataset(ABC):
    ...
    def _whiten_kdata(self):
        ...
        # cpu implementation is faster than cuda if only performed once, and whitening requires a lot of memory
        if cp is not None:
        ...
        try:
            ...
            k_data_temp = sigpy.mri.whiten(k_data_temp, noise_cov_temp)  # whiten
            ...
            logging.warning('Whitening failed because covariance matrix is not positive definited, skipping')
            return
